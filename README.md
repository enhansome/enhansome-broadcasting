...
* [ffplayout](https://github.com/ffplayout/ffplayout) ⭐ 574 | 🐛 24 | 🌐 Rust | 📅 2026-08-17 - Rust and FFmpeg based playout from folder or playlists.
...
* [SPX - Graphics Controller](https://github.com/TuomoKu/SPX-GC) ⭐ 419 | 🐛 32 | 🌐 JavaScript | 📅 2026-06-16 - Graphics control client for live video productions and live streams.
...
* [OGraf](https://github.com/ebu/ograf) ⭐ 114 | 🐛 12 | 🌐 JavaScript | 📅 2026-08-13 - Open specification for HTML based Graphics, used in live television and post production workflows.
...
* [OnAirScreen](https://github.com/saschaludwig/OnAirScreen) ⭐ 116 | 🐛 6 | 🌐 Python | 📅 2026-08-04 - Cross-platform "OnAir Lamp" solution targeted for use in professional broadcast environments.
...
* [OATIS](https://github.com/jamiehull/OATIS) ⭐ 4 | 🐛 2 | 🌐 Python | 📅 2026-08-16 - Server Based Studio Clock and Tally system, supporting messaging, physical GPI's and OSC triggering.
...
* [Intercom Manager](https://github.com/Eyevinn/intercom-manager) ⭐ 86 | 🐛 69 | 🌐 TypeScript | 📅 2026-08-10 + [Intercom Frontend](https://github.com/Eyevinn/intercom-frontend) ⭐ 68 | 🐛 84 | 🌐 TypeScript | 📅 2026-08-10 - Intercom system based on built by Eyevinn for SVT.
...
* [Bitfocus Companion](https://github.com/bitfocus/companion) ⭐ 2,254 | 🐛 300 | 🌐 TypeScript | 📅 2026-08-17 - Enables the Elgato Streamdeck and other controllers to be a shotbox surface for an [increasing amount of broadcast equipment](https://bitfocus.io/connections).
...
* [VideoIPath-Automation-Tool](https://github.com/SWR-MoIP/VideoIPath-Automation-Tool) ⭐ 12 | 🐛 1 | 🌐 Python | 📅 2026-08-17 - A Python package for automating VideoIPath configuration workflows.
...
* [Kodi](https://github.com/xbmc/xbmc) ⭐ 21,100 | 🐛 446 | 🌐 C++ | 📅 2026-08-17 - A software media player and entertainment hub for digital media.
* [rx-player](https://github.com/canalplus/rx-player) ⭐ 932 | 🐛 74 | 🌐 TypeScript | 📅 2026-08-17 - HTML5/Javascript video player that supports MPEG-DASH and SmoothStreaming.
...
* [BMXlib](https://github.com/ebu/bmx) ⭐ 49 | 🐛 11 | 🌐 C++ | 📅 2026-08-14 - Library and utilities to read and write broadcasting media files. Primarily supports the MXF file format.
...
* [VMAF](https://github.com/Netflix/vmaf) ⭐ 5,454 | 🐛 111 | 🌐 C | 📅 2026-08-14 - Perceptual video quality assessment based on multi-method fusion.
...
* [OBS-Studio](https://github.com/obsproject/obs-studio) ⭐ 75,131 | 🐛 1,177 | 🌐 C | 📅 2026-08-15 - Software for live streaming and screen recording.
* [Flowblade](https://github.com/jliljebl/flowblade) ⭐ 3,084 | 🐛 59 | 🌐 Python | 📅 2026-06-23 - A multitrack non-linear video editor.
...
* [MP4Box.js](https://github.com/gpac/mp4box.js) ⭐ 2,460 | 🐛 40 | 🌐 TypeScript | 📅 2026-07-28 - JavaScript library to process MP4 files in the browser (and in NodeJS).
* [VideoContext](https://github.com/bbc/videocontext) ⭐ 1,354 | 🐛 40 | 🌐 JavaScript | 📅 2023-07-18 - Experimental HTML5/WebGL library for creating interactive and responsive web videos.
...
* [Voctomix](https://github.com/voc/voctomix) ⭐ 634 | 🐛 98 | 🌐 Python | 📅 2026-08-16 - Customizable conference recording/mixing/streaming software based on Python and GStreamer.
...
* [SVT Encore](https://github.com/svt/encore) ⭐ 336 | 🐛 15 | 🌐 Kotlin | 📅 2026-07-01 - Selfhosted video transcoding platform, built around FFmpeg.
...
* [Fio](https://github.com/axboe/fio) ⭐ 6,334 | 🐛 241 | 🌐 C | 📅 2026-08-07 - Flexible I/O Tester
...
* [Easy-NMOS](https://github.com/rhastie/easy-nmos) ⭐ 87 | 🐛 14 | 🌐 Lua | 📅 2026-08-15 - A starter kit that allows the user to launch a simple NMOS setup with minimal installation steps, composed of three Docker containers: an NMOS Registry, a virtual NMOS Node, and the AMWA NMOS Testing Tool.
* [nmos-js](https://github.com/sony/nmos-js) ⭐ 46 | 🐛 8 | 🌐 JavaScript | 📅 2026-08-13 - A simple browser-based NMOS Client/Controller with an IS-04 Registry browser and IS-05 Connection Management.
* [NVIDIA NMOS Library](https://github.com/NVIDIA/nvnmos) ⭐ 21 | 🐛 4 | 🌐 Rust | 📅 2026-08-17 (NvNmos) - A simple-to-use C/C++ library for adding an NMOS Node to your application, with support for IS-04, IS-05, BCP-002-01, BCP-002-02, BCP-004-01, etc.
...
* [nmos-device-control-mock](https://github.com/AMWA-TV/nmos-device-control-mock) ⭐ 12 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-17 - A mock device implementation of the NMOS Control & Monitoring suite (IS-12, BCP-008-01, BCP-008-02), written in Typescript and running on the NodeJS stack.
...
* [AntennaPod](https://github.com/AntennaPod/AntennaPod) ⭐ 8,084 | 🐛 362 | 🌐 Java | 📅 2026-08-14 - A podcast manager for Android ([antennapod.org](https://antennapod.org/)).
* [Castopod](https://github.com/ad-aures/castopod) ⭐ 864 | 🐛 0 | 🌐 PHP | 📅 2026-06-05 - Podcast Hosting and Broadcasting ([castopod.org](https://castopod.org/)).
...
* [Podlove Publisher](https://github.com/podlove/podlove-publisher) ⭐ 309 | 🐛 192 | 🌐 PHP | 📅 2026-08-17 - Podcast Publisher for WordPress.
* [Podlove Web Player](https://github.com/podlove/podlove-ui) ⭐ 92 | 🐛 55 | 🌐 TypeScript | 📅 2026-01-30 - Podcast-optimized, HTML5-based video and audio player.
...
* [AzuraCast](https://github.com/AzuraCast/AzuraCast) ⭐ 3,996 | 🐛 102 | 🌐 PHP | 📅 2026-08-15 - A self-hosted web radio management suite.
* [Liquidsoap](https://github.com/savonet/liquidsoap) ⭐ 1,721 | 🐛 275 | 🌐 OCaml | 📅 2026-08-17 - A Swiss army knife for multimedia streaming ([documentation](https://www.liquidsoap.info/doc.html)).
...
* [OnTime](https://github.com/cpvalente/ontime) ⭐ 940 | 🐛 43 | 🌐 TypeScript | 📅 2026-08-17 - Web based time keeping system for live events with a broadcast clock view.
* [SuperConductor](https://github.com/SuperFlyTV/SuperConductor) ⭐ 350 | 🐛 76 | 🌐 TypeScript | 📅 2026-06-02 - Rundown/playout controller for CasparCG Server, BMD ATEM, OBS Studio, vMix, OSC-compatible devices, HTTP (REST)-compatible devices among others.
...
* [PeerTube](https://github.com/Chocobozzz/PeerTube) ⭐ 15,268 | 🐛 691 | 🌐 TypeScript | 📅 2026-08-17 - ActivityPub-federated video streaming platform using P2P directly in your web browser. (<https://joinpeertube.org/>)
* [Owncast](https://github.com/owncast/owncast) ⭐ 11,466 | 🐛 174 | 🌐 Go | 📅 2026-08-17 - Selfhosted video streaming platform (<https://owncast.online/>)

## Subtitling

* [ttconv](https://github.com/sandflow/ttconv) ⭐ 236 | 🐛 36 | 🌐 Python | 📅 2026-08-17 - Subtitle conversion library and CLI tool. Converts between STL, SRT, TTML, SCC, TTML and WebVTT files.
...
Please see [CONTRIBUTING](https://github.com/ebu/awesome-broadcasting/blob/master/CONTRIBUTING.md) ⭐ 1,764 | 🐛 13 | 📅 2026-04-29 for details.
