...
* [OGraf](https://github.com/ebu/ograf) ⭐ 114 | 🐛 12 | 🌐 JavaScript | 📅 2026-08-20 - Open specification for HTML based Graphics, used in live television and post production workflows.
...
* [Intercom Manager](https://github.com/Eyevinn/intercom-manager) ⭐ 86 | 🐛 69 | 🌐 TypeScript | 📅 2026-08-20 + [Intercom Frontend](https://github.com/Eyevinn/intercom-frontend) ⭐ 68 | 🐛 84 | 🌐 TypeScript | 📅 2026-08-20 - Intercom system based on built by Eyevinn for SVT.
...
* [Bitfocus Companion](https://github.com/bitfocus/companion) ⭐ 2,260 | 🐛 301 | 🌐 TypeScript | 📅 2026-08-20 - Enables the Elgato Streamdeck and other controllers to be a shotbox surface for an [increasing amount of broadcast equipment](https://bitfocus.io/connections).
...
* [Kodi](https://github.com/xbmc/xbmc) ⭐ 21,109 | 🐛 452 | 🌐 C++ | 📅 2026-08-20 - A software media player and entertainment hub for digital media.
* [rx-player](https://github.com/canalplus/rx-player) ⭐ 932 | 🐛 77 | 🌐 TypeScript | 📅 2026-08-20 - HTML5/Javascript video player that supports MPEG-DASH and SmoothStreaming.
...
* [VMAF](https://github.com/Netflix/vmaf) ⭐ 5,454 | 🐛 112 | 🌐 C | 📅 2026-08-14 - Perceptual video quality assessment based on multi-method fusion.
...
* [Pi Audio Monitor](https://github.com/martim01/pam) ⭐ 183 | 🐛 21 | 🌐 C++ | 📅 2026-04-30 - Audio Monitoring for Raspberry Pi, supports S/PDIF, AES3, AES67, Livewire and Ravenna.
...
* [OBS-Studio](https://github.com/obsproject/obs-studio) ⭐ 75,248 | 🐛 1,174 | 🌐 C | 📅 2026-08-20 - Software for live streaming and screen recording.
* [Flowblade](https://github.com/jliljebl/flowblade) ⭐ 3,086 | 🐛 59 | 🌐 Python | 📅 2026-06-23 - A multitrack non-linear video editor.
* [Bento4](https://github.com/axiomatic-systems/Bento4) ⭐ 2,487 | 🐛 595 | 🌐 C++ | 📅 2026-06-27 - Full-featured MP4 format and MPEG DASH C++ class library and tools.
...
* [Fio](https://github.com/axboe/fio) ⭐ 6,339 | 🐛 237 | 🌐 C | 📅 2026-08-20 - Flexible I/O Tester
...
* [nmos-cpp](https://github.com/sony/nmos-cpp) ⭐ 187 | 🐛 79 | 🌐 C++ | 📅 2026-08-13 - An implementation of the AMWA Networked Media Open Specifications in C++, including an NMOS Registry and a toolkit and example of building an NMOS Node.
* [Easy-NMOS](https://github.com/rhastie/easy-nmos) ⭐ 87 | 🐛 11 | 🌐 Lua | 📅 2026-08-15 - A starter kit that allows the user to launch a simple NMOS setup with minimal installation steps, composed of three Docker containers: an NMOS Registry, a virtual NMOS Node, and the AMWA NMOS Testing Tool.
* [nmos-js](https://github.com/sony/nmos-js) ⭐ 48 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-20 - A simple browser-based NMOS Client/Controller with an IS-04 Registry browser and IS-05 Connection Management.
* [NVIDIA NMOS Library](https://github.com/NVIDIA/nvnmos) ⭐ 21 | 🐛 4 | 🌐 Rust | 📅 2026-08-20 (NvNmos) - A simple-to-use C/C++ library for adding an NMOS Node to your application, with support for IS-04, IS-05, BCP-002-01, BCP-002-02, BCP-004-01, etc.
...
* [DELTACAST IP Virtual Card NMOS samples](https://github.com/deltacasttv/nmos-ipvc-samples) ⭐ 6 | 🐛 1 | 🌐 C++ | 📅 2024-10-02 - A demonstration of the integration of several NMOS standards with the DELTACAST IP Virtual Card through [nmos-cpp](https://github.com/sony/nmos-cpp) ⭐ 187 | 🐛 79 | 🌐 C++ | 📅 2026-08-13.
...
* [AntennaPod](https://github.com/AntennaPod/AntennaPod) ⭐ 8,094 | 🐛 360 | 🌐 Java | 📅 2026-08-20 - A podcast manager for Android ([antennapod.org](https://antennapod.org/)).
...
* [AzuraCast](https://github.com/AzuraCast/AzuraCast) ⭐ 4,005 | 🐛 106 | 🌐 PHP | 📅 2026-08-20 - A self-hosted web radio management suite.
* [Liquidsoap](https://github.com/savonet/liquidsoap) ⭐ 1,719 | 🐛 273 | 🌐 OCaml | 📅 2026-08-20 - A Swiss army knife for multimedia streaming ([documentation](https://www.liquidsoap.info/doc.html)).
...
* [OnTime](https://github.com/cpvalente/ontime) ⭐ 943 | 🐛 42 | 🌐 TypeScript | 📅 2026-08-19 - Web based time keeping system for live events with a broadcast clock view.
...
* [PeerTube](https://github.com/Chocobozzz/PeerTube) ⭐ 15,272 | 🐛 683 | 🌐 TypeScript | 📅 2026-08-20 - ActivityPub-federated video streaming platform using P2P directly in your web browser. (<https://joinpeertube.org/>)
* [Owncast](https://github.com/owncast/owncast) ⭐ 11,466 | 🐛 175 | 🌐 Go | 📅 2026-08-20 - Selfhosted video streaming platform (<https://owncast.online/>)

## Subtitling

* [ttconv](https://github.com/sandflow/ttconv) ⭐ 238 | 🐛 34 | 🌐 Python | 📅 2026-08-18 - Subtitle conversion library and CLI tool. Converts between STL, SRT, TTML, SCC, TTML and WebVTT files.
