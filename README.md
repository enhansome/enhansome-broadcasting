...
* [ffplayout](https://github.com/ffplayout/ffplayout) ⭐ 588 | 🐛 24 | 🌐 Rust | 📅 2026-09-15 - Rust and FFmpeg based playout from folder or playlists.
...
* [SPX - Graphics Controller](https://github.com/TuomoKu/SPX-GC) ⭐ 421 | 🐛 32 | 🌐 JavaScript | 📅 2026-06-16 - Graphics control client for live video productions and live streams.
...
* [Intercom Manager](https://github.com/Eyevinn/intercom-manager) ⭐ 90 | 🐛 75 | 🌐 TypeScript | 📅 2026-09-15 + [Intercom Frontend](https://github.com/Eyevinn/intercom-frontend) ⭐ 68 | 🐛 83 | 🌐 TypeScript | 📅 2026-09-15 - Intercom system based on built by Eyevinn for SVT.
...
* [Bitfocus Companion](https://github.com/bitfocus/companion) ⭐ 2,289 | 🐛 291 | 🌐 TypeScript | 📅 2026-09-15 - Enables the Elgato Streamdeck and other controllers to be a shotbox surface for an [increasing amount of broadcast equipment](https://bitfocus.io/connections).
* [MIDIMonster](https://github.com/cbdevnet/midimonster) ⭐ 604 | 🐛 52 | 🌐 C | 📅 2024-06-24 - Lightweight adapter tool for common show control protocols.
...
* [Kodi](https://github.com/xbmc/xbmc) ⭐ 21,223 | 🐛 461 | 🌐 C++ | 📅 2026-09-16 - A software media player and entertainment hub for digital media.
* [rx-player](https://github.com/canalplus/rx-player) ⭐ 935 | 🐛 81 | 🌐 TypeScript | 📅 2026-09-14 - HTML5/Javascript video player that supports MPEG-DASH and SmoothStreaming.
...
* [libklvanc](https://github.com/stoth68000/libklvanc) ⭐ 70 | 🐛 4 | 🌐 C | 📅 2026-09-01 - C library for ancillary data extraction from SDI and SMPTE ST 2110-40 (CEA-708, AFD, SCTE-104, etc.).
* [libadm](https://github.com/ebu/libadm) ⭐ 51 | 🐛 44 | 🌐 C++ | 📅 2026-08-07 - Audio Definition Model (ITU-R BS.2076) handling C++11 library.
* [BMXlib](https://github.com/ebu/bmx) ⭐ 50 | 🐛 13 | 🌐 C++ | 📅 2026-08-14 - Library and utilities to read and write broadcasting media files. Primarily supports the MXF file format.
...
* [VMAF](https://github.com/Netflix/vmaf) ⭐ 5,482 | 🐛 120 | 🌐 C | 📅 2026-09-15 - Perceptual video quality assessment based on multi-method fusion.
...
* [OBS-Studio](https://github.com/obsproject/obs-studio) ⭐ 76,252 | 🐛 1,142 | 🌐 C | 📅 2026-09-15 - Software for live streaming and screen recording.
* [Flowblade](https://github.com/jliljebl/flowblade) ⭐ 3,090 | 🐛 56 | 🌐 Python | 📅 2026-09-15 - A multitrack non-linear video editor.
* [Bento4](https://github.com/axiomatic-systems/Bento4) ⭐ 2,501 | 🐛 620 | 🌐 C++ | 📅 2026-06-27 - Full-featured MP4 format and MPEG DASH C++ class library and tools.
...
* [SVT Encore](https://github.com/svt/encore) ⭐ 337 | 🐛 15 | 🌐 Kotlin | 📅 2026-09-14 - Selfhosted video transcoding platform, built around FFmpeg.
...
* [Fio](https://github.com/axboe/fio) ⭐ 6,368 | 🐛 235 | 🌐 C | 📅 2026-09-11 - Flexible I/O Tester
...
* [nmos-device-control-mock](https://github.com/AMWA-TV/nmos-device-control-mock) ⭐ 12 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-14 - A mock device implementation of the NMOS Control & Monitoring suite (IS-12, BCP-008-01, BCP-008-02), written in Typescript and running on the NodeJS stack.
...
* [AntennaPod](https://github.com/AntennaPod/AntennaPod) ⭐ 8,158 | 🐛 370 | 🌐 Java | 📅 2026-09-12 - A podcast manager for Android ([antennapod.org](https://antennapod.org/)).
...
* [AzuraCast](https://github.com/AzuraCast/AzuraCast) ⭐ 4,037 | 🐛 120 | 🌐 PHP | 📅 2026-09-09 - A self-hosted web radio management suite.
* [Liquidsoap](https://github.com/savonet/liquidsoap) ⭐ 1,732 | 🐛 274 | 🌐 OCaml | 📅 2026-09-15 - A Swiss army knife for multimedia streaming ([documentation](https://www.liquidsoap.info/doc.html)).
...
* [Rivendell](https://github.com/ElvishArtisan/rivendell) ⭐ 242 | 🐛 250 | 🌐 C++ | 📅 2026-08-26 - Complete radio broadcast automation solution, translated to many languages and used worldwide.
...
* [OnTime](https://github.com/cpvalente/ontime) ⭐ 950 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-15 - Web based time keeping system for live events with a broadcast clock view.
...
* [threefive](https://github.com/superkabuki/threefive_is_scte35) ⭐ 23 | 🐛 1 | 🌐 Python | 📅 2026-09-12 - SCTE-35 Parser and Encoder for MPEGTS.
...
* [PeerTube](https://github.com/Chocobozzz/PeerTube) ⭐ 15,314 | 🐛 690 | 🌐 TypeScript | 📅 2026-09-15 - ActivityPub-federated video streaming platform using P2P directly in your web browser. (<https://joinpeertube.org/>)
* [Owncast](https://github.com/owncast/owncast) ⭐ 11,531 | 🐛 167 | 🌐 Go | 📅 2026-09-15 - Selfhosted video streaming platform (<https://owncast.online/>)

## Subtitling

* [ttconv](https://github.com/sandflow/ttconv) ⭐ 238 | 🐛 35 | 🌐 Python | 📅 2026-09-15 - Subtitle conversion library and CLI tool. Converts between STL, SRT, TTML, SCC, TTML and WebVTT files.
* [imscJS](https://github.com/sandflow/imscJS) ⭐ 91 | 🐛 26 | 🌐 JavaScript | 📅 2026-09-15 - JavaScript library for rendering IMSC1 Text and Image Profile documents to HTML5.
...
Please see [CONTRIBUTING](https://github.com/ebu/awesome-broadcasting/blob/master/CONTRIBUTING.md) ⭐ 1,771 | 🐛 15 | 📅 2026-04-29 for details.
